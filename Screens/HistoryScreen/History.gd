...
var current_menu := []
var current_ask := {"character": {}, "question": "", "answer": ""}
...
func add_to_history(type: String, character: Dictionary, text: String, extra := {}) -> void:
	...
	var new_item = {"type": type, "character": character, "text": text}
...
func _on_answer_return(answer: String) -> void:
	...
	add_to_history("ask", current_ask["character"], current_ask["question"], {"answer": answer})
